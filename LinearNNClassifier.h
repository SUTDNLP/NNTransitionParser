...
class LinearNNClassifier {
public:
  LinearNNClassifier();
  virtual ~LinearNNClassifier();
...
public:
  ...
  void init(int wordDim, int wordSize, int wordcontext, int atomDim, int atomSize, int atomcontext, int lay1OutDim, int labelSize, int linearfeatSize);

  void init(const mat& wordEmb, int wordcontext, int atomDim, int atomSize, int atomcontext, int lay1OutDim, int labelSize, int linearfeatSize);
